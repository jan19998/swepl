<!-- Neuer Footer hatte zu Fehlern bei der Startseite geführt -->
<!-- Deshalb eigener Footer für die Startseite -->
<footer>
    <div class="row justify-content-center pt-3">
        <div class="col justify-content-center">
            <ul class="list-group list-group-horizontal justify-content-center">
                ...
                <li class="list-group-item border-top-0 border-bottom-0 border-right-0"><a class="link" href="#">Passwort ändern</a></li>
            </ul>
        </div>
    </div>
</footer>